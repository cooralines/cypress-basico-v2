// CAC-TAT.spec.js created with Cypress
    ...
    describe('Central de Atendimento ao Cliente TAT', function() {
        ...
        it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
            ...
            cy.get('#email')
            .type('cooralines.almeida@gmail.com')
            .should('have.value', 'cooralines.almeida@gmail.com')
            .clear()
            .should('have.value', '')

            cy.get('#phone')
            .type('832032224')
            .should('have.value', '832032224')
            .clear()
            .should('have.value', '')
        })
        ...
        it('Crie um teste chamado marca cada tipo de atendimento', function(){
        ...
        it('Crie um teste chamado seleciona um arquivo da pasta fixtures', function(){
        ...
        it('Crie um teste chamado seleciona um arquivo simulando um drag-and-drop', function(){
            cy.get('input[type="file"]')
            .should('not.have.value')
      ...
      it('Crie um teste chamado verifica que a política de privacidade abre em outra aba sem a necessidade de um clique', function(){
        cy.get('#privacy a')
